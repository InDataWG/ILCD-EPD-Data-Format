...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ilcd="http://lca.jrc.it/ILCD" xmlns:process="http://lca.jrc.it/ILCD/Process"
    ...
    <xsl:variable name="defaultCategoriesFile" select="'../sample_data/OEKOBAU.DAT_Categories.xml'"/>
    <xsl:variable name="referenceCategoriesFile" select="'../sample_data/OEKOBAU.DAT_Categories.xml'"/>
