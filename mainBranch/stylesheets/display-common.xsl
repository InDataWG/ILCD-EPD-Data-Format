                ...
                <xsl:when
                    ...
                    <xsl:variable name="result1">
                        <xsl:for-each select="$schemaDocument">
                            ...
                            <xsl:value-of
                                select="key('schemaDocumentElementKey',concat('common:',$fieldName))[ancestor::xs:complexType[@name=$parentType]]//ilcd:display-name/text()"/>
                        </xsl:for-each>
                    </xsl:variable>
                    <xsl:choose>
                ...
                <xsl:when
                    ...
                    <xsl:variable name="result1">
                        <xsl:for-each select="$schemaDocument">
                            ...
                            <xsl:value-of
                                select="key('schemaDocumentElementKey',concat('common:',$fieldName))[ancestor::xs:complexType[@name=$parentType]]//xs:documentation/text()"/>
                        </xsl:for-each>
                    </xsl:variable>
                    <xsl:choose>
                        <xsl:when test="normalize-space($result1)!=''">
